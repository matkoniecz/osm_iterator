...
python3 ../../python_package_reinstaller/reinstaller.py osm_iterator # yes, it relies on code on my computer - let me know if anyone else wants to run this script
